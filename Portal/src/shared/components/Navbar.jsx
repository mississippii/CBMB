      ...
      <div className="app-navbar-inner">
        ...
        <div className="navbar-actions flex items-center gap-2.5" ref={menuRef}>
          <div className="relative">
            ...
            {open && (
              <div className="absolute right-0 z-50 mt-2 w-80 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-2xl">
                {/* Identity header — business name is the title */}
                <div className="flex items-center gap-3 border-b border-slate-100 bg-slate-50 px-5 py-4">
                  <span className="relative flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 text-white shadow-sm shadow-indigo-500/30">
                    <HeaderIcon size={26} />
                    <span className="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-slate-50 bg-emerald-500" />
                  </span>
                  <div className="min-w-0">
                    <p className="truncate text-lg font-extrabold leading-tight text-slate-900">{accountName}</p>
